...
import (
	...
	_ "github.com/SOAT-46/fastfood-operations/internal/orders/adapters/http/responses"
	...
	_ "github.com/SOAT-46/fastfood-operations/internal/shared/infrastructure/controllers/page"
...
func (itself GetOrdersController) onEmpty() {
	itself.gcontext.Writer.WriteHeader(http.StatusNoContent)
}
